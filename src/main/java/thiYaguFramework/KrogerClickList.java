...
public class KrogerClickList {
	...
	// Page Objects
	// By zipcodeTextArea =
	// By.cssSelector("form[class^='pickup-store-search-field']");
	...
	public void EnterZipCodeWithJS(String zipcode) {
		...
		WebElement textarea1 = (WebElement) js.executeScript(
				"return document.evaluate(\"//input[@name='store' and @data-qa='pickup store search input']\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue");
	...
	public void ClickSubmit() {
		...
		WebElement value = (WebElement) js.executeScript(
				"return document.evaluate(\"//input[@type='submit' and @ng-disabled='!storeSearchTerm']\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue");
		if (value.isEnabled()) {
		...
		// js.executeScript("document.getElementsByClassName('pickup-store-search-field
		// ng-valid ng-dirty ng-valid-parse')[0].children[1].click()");
	}
